...
It seems that worked, so I've proceeded to access it in a browser with the token that I crafted:<br>
...
That seemed to work fine authentication-wise and it seemed that the query got executed:  
